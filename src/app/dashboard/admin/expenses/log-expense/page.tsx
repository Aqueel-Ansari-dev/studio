...
import { PlusCircle, Landmark, DollarSign, Tag, FileText, Receipt, Image as ImageIcon } from "lucide-react";
...
export default function AdminLogExpensePage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Log Expense (Admin)" description="Submit your expenses for tracking or reimbursement." />
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>As an admin, your logged expenses are auto-approved.</CardDescription>
        </CardHeader>
        <CardContent>
