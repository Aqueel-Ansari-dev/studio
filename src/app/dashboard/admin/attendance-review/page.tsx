...
export default function AdminAttendanceReviewPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Admin Attendance Overview" 
        description="Review all employee attendance logs and utilize AI for insights."
        actions={
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Logs for Review ({logsForReview.length})</CardTitle>
          <CardDescription>All attendance logs pending admin review. Trigger AI analysis for insights.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
       ...
       <Card>
        <CardHeader>
          <CardTitle className="font-headline">Admin Reviewed Logs ({processedLogs.length})</CardTitle>
          <CardDescription>Attendance logs that have been marked by an admin.</CardDescription>
        </CardHeader>
        <CardContent>
           {isLoading ? (
            <div className="text-center py-4"><RefreshCw className="mr-2 h-6 w-6 animate-spin" /> Loading logs...</div>
