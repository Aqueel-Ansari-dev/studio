            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <Switch id={`recommended-${plan.id}`} {...form.register('recommended')} />
                        <Label htmlFor={`recommended-${plan.id}`}>Recommended</Label>
                    </div>
                     <div className="flex items-center space-x-2">
                        <Switch id={`contactUs-${plan.id}`} {...form.register('contactUs')} />
...
export default function OwnerDashboardPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader title="Owner Dashboard" description="Manage subscription plans and view system stats." />
            
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline flex items-center"><Crown className="mr-2"/>Manage Subscription Plans</CardTitle>
