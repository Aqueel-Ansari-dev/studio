...
export function SupervisorTasksView({ projectId, initialProjectDetails }: SupervisorTasksViewProps) {
  ...
  const loadTasks = useCallback(async () => {
    ...
    try {
      ...
      console.error("[SupervisorTasksView] Failed to load project tasks:", error);
      toast({
